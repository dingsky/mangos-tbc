...
void WorldSession::HandleSwapInvItemOpcode(WorldPacket& recv_data)
{
    ...
    uint8 srcslot, dstslot; //Ô´Î»ÖÃ,Ä¿±êÎ»ÖÃ
...
void WorldSession::HandleItemQuerySingleOpcode(WorldPacket& recv_data)
{
    ...
    if (pProto) //ï¿½ï¿½ï¿½ï¿½éµ?, ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Æ·ï¿½ï¿½Ï¢
    {
        ...
        data << pProto->DisplayInfoID;          //ï¿½ï¿½Ê¾ï¿½ï¿½Æ·ï¿½ï¿½ï¿?
        data << pProto->Quality;                //ï¿½ï¿½ï¿½ï¿½??
        data << pProto->Flags;                  //ï¿½ï¿½Ö¾
        data << pProto->BuyPrice;               //ï¿½ï¿½ï¿½ï¿½Û¸ï¿?
        data << pProto->SellPrice;              //ï¿½ï¿½ï¿½Û¼Û¸ï¿½
        data << pProto->InventoryType;          //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
        data << pProto->AllowableClass;         //ï¿½ï¿½ï¿½ï¿½ï¿½Ö°Ò?
        data << pProto->AllowableRace;          //ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿?
        data << pProto->ItemLevel;              //ï¿½ï¿½Æ·ï¿½ï¿½ï¿½ï¿½
        data << pProto->RequiredLevel;          //ï¿½ï¿½Òªï¿½ÄµÈ¼ï¿½
        data << pProto->RequiredSkill;          //ï¿½ï¿½Òªï¿½Ä¼ï¿½ï¿½ï¿½
        data << pProto->RequiredSkillRank;      //ï¿½ï¿½Òªï¿½Ä¼ï¿½ï¿½ÜµÈ¼ï¿½
        data << pProto->RequiredSpell;          //ï¿½ï¿½Òªï¿½Ä·ï¿½ï¿½ï¿½
        data << pProto->RequiredHonorRank;      //ï¿½ï¿½Òªï¿½Ä·ï¿½ï¿½ï¿½ï¿½È¼ï¿½
        data << pProto->RequiredCityRank;       //ï¿½ï¿½Òªï¿½Ä³ï¿½ï¿½ÐµÈ¼ï¿½
        data << pProto->RequiredReputationFaction;  //ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½É±ï¿½
        data << pProto->RequiredReputationRank; //ï¿½ï¿½Òªï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½È¼ï¿½
        data << pProto->MaxCount;               //ï¿½ï¿½ï¿½Ð?ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½
        data << pProto->Stackable;              //ï¿½Ç·ï¿½É¶Ñµï¿?
        data << pProto->ContainerSlots;         //ï¿½ï¿½ï¿???
        ...
        // resistances (7)
        data << pProto->Armor;              //×°ï¿½ï¿½
        data << pProto->HolyRes;            //ï¿½ï¿½Ê¥
        data << pProto->FireRes;
...
void WorldSession::HandleReadItemOpcode(WorldPacket& recv_data)
{
    ...
    //ï¿½ï¿½ï¿½ï¿½ï¿½Æ·ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½Ä±ï¿½Ò?
    if (pItem && pItem->GetProto()->PageText)
    {
        WorldPacket data;

        //ï¿½Ð¶ï¿½ï¿½Ç·ï¿½ï¿½ï¿½ï¿½Ê¹ï¿½ï¿?
...
void WorldSession::HandleSellItemOpcode(WorldPacket& recv_data)
{
    ...
    ObjectGuid vendorGuid;  //售卖NPC的guid
    ObjectGuid itemGuid;    //被售卖物品guid
    uint8 _count;           //数量
...
void WorldSession::HandleBuyItemInSlotOpcode(WorldPacket& recv_data)
{
    ...
    ObjectGuid vendorGuid;  //售卖NPC的guid
    ObjectGuid bagGuid;     //背包guid
    uint32 item;            //物品ID
    uint8 bagslot, count;   //背包位置,数量
